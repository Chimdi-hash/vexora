...
- The commits after `87b679dffea13640e75d23b52a6392b817724504` are documentation/evidence-only and do not change `contracts/vexora.py`; no redeployment is required for those edits.
- Network: StudioNet
...
- `is_vexora_active(1, wrong-agreement-hash)` returned `false`.
...
- Competing child attempt: `0xa36d90b0a95c3c989328d556cf21ead1351365fcde0254c04af513bc55a7dafd`; finalized with execution error `EXPECTED: parent vexora must be active`.
